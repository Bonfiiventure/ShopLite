...
def register():
    if request.method == 'POST':
        ...
        if passw!=passw_again:
            return render_template('register.html',msg3="Password do not match!")
        # Check password strength  , this stops password brute force.
        elif (len(passw)<8):
                    return render_template('register.html', msg3="Must be more than 8 -ters")

        elif not re.search("[a-z]", passw):
                    return render_template('register.html', msg3="Must have small letters")
